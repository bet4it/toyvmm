...
pub fn event_loop(
    ...
    vcpu_fds: Vec<VcpuFd>,
    gdb_event_receiver: Receiver<(usize, Sender<()>)>,
    entry_addr: GuestAddress,
) {
    let mut target = FirecrackerTarget::new(guest_memory, vcpu_fds, gdb_event_receiver, entry_addr);
